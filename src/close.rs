...
impl Miner {
    pub async fn close(&self) {
        ...
        if !ask_confirm(
            format!("{} You have {} GEMM staked in this account.\nAre you sure you want to {}close this account? [Y/n]", 
                "WARNING".yellow(),
                amount_to_ui_amount(proof.balance, gemm_api::consts::TOKEN_DECIMALS),
        ...
        let ix = gemm_api::instruction::close(signer.pubkey());
